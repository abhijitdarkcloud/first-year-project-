...
TARGET_FOLDER_NAME = "Kdrama_Shorts"  # Updated folder name for K-drama content
DIRECT_FOLDER_MODE = True  # Set to True to process videos directly from the main folder instead of subfolders
SPREADSHEET_ID = '1ROcI3sYP0b_Uq3ipUhKzzpvjS1JxpOHmej4dqgiRihU'  # Updated spreadsheet ID
SHEET_NAME = 'Sheet1'
...
DEFAULT_YOUTUBE_CHANNEL = "Seoulrush"  # Default channel to use if none specified

# Telegram Bot configuration
TELEGRAM_BOT_TOKEN = "7242554903:AAG1mbbW8h6BF0sPc0qLgZ-1HVlnRgLZk1w"
TELEGRAM_CHAT_ID = "-1002493560505"
TELEGRAM_THREAD_ID = 2114
...
def get_google_drive_credentials():
    ...
    CREDENTIALS_DRIVE_LINK = "https://drive.google.com/file/d/1k8H2bJc1Ma4DM4nq98Kwr74PKn3nUw4m/view?usp=sharing"
...
def get_youtube_credentials(channel_id=None, channel_name=None):
    ...
    CHANNEL_DRIVE_LINKS = {
        "Seoulrush": "https://drive.google.com/file/d/1lsTsfbB-M0XSMcXT1XCtaLJQ-YTorYhP/view?usp=sharing",
        "Sarangify": "https://drive.google.com/file/d/1RqFE_JuAFM0Tgmo32dtE-4VgpzmlPJlr/view?usp=sharing",
        "Ksnapz": "https://drive.google.com/file/d/1-5uhvA38CEB8UJA-eylq0RgSi94mDp1r/view?usp=sharing",
        "Kromance": "https://drive.google.com/file/d/1jzhd_66HbaOQDWP5J9hWMZtxyvrcG_sY/view?usp=sharing",
        "Kflicks": "https://drive.google.com/file/d/1uYsoxv-cA4RmxXC-Q0OTKBBHuMkPpskO/view?usp=sharing",
        "Kdramatics": "https://drive.google.com/file/d/1ZtBIMJL7Byu8wsW8VGHZds6q53OkcbL3/view?usp=sharing",
        "Kclipped": "https://drive.google.com/file/d/1S1m7tFcnqDL2v7eAvWsXQMv933-zxnkb/view?usp=sharing",
        "Kblitz": "https://drive.google.com/file/d/1ipILv--TrNcNkWu5GPgPsiPC7-a5F8UZ/view?usp=sharing",
        "Dramify": "https://drive.google.com/file/d/1KFkp-ooaiElmhNPIksynaSBD0VIKWrjC/view?usp=sharing",
        "DramaDrop": "https://drive.google.com/file/d/1u27rnli9zQnsFioREvXK5EBxAviUPZZC/view?usp=sharing"
    }
...
Your K-Drama channel is growing strong! 💕📈

Just uploaded a fresh K-content to {channel_title} 🌟

📝 Title: {title}
📂 From: {folder_name}
🔗 Watch here: {video_url}

Hallyu wave keeps expanding! 💪🔥
#KDrama #KoreanContent #HallyuSuccess 🇰🇷"""
    ...
    try:
        ...
        for idx, video_file in enumerate(selected_videos):
            ...
            try:
                ...
                description = f"Korean drama clips and highlights: {title}"
                tags = ["kdrama", "shorts", "korean drama", "hallyu", "kpop"]
